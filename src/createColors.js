module.exports = (colors) => ({
    ...
    'list.invalidItemForeground': colors.redDiag,
    'list.errorForeground': colors.redDiag,
    'list.warningForeground': colors.yellowDiag,
    'listFilterWidget.background': colors.bg1,
    'listFilterWidget.outline': colors.bg3,
    'listFilterWidget.noMatchesOutline': colors.redDiag,
    ...
    // "editor.selectionHighlightBorder": colors.yellow,
    // "editor.wordHighlightBorder": colors.yellow,
    // "editor.wordHighlightStrongBorder": colors.yellow,
    // "editor.findMatchBorder": colors.fg2,
    // "editor.findMatchHighlightBorder": colors.fg2,
    // "editor.findRangeHighlightBorder": colors.fg2,
    // "editor.rangeHighlightBorder": colors.fg2,
    ...
    'editor.selectionBackground': colors.bg3,
    ...
    'editor.findMatchBackground': colors.bg3,
    'editor.findMatchHighlightBackground': colors.bg3,
    ...
    'editorMarkerNavigationError.background': colors.redDiag,
    'editorMarkerNavigationWarning.background': colors.yellowDiag,
